...
unlocked to sign the NewBit-Qt.app bundle.
...
allowing somebody to distribute a NewBit-Qt.app or newbit-qt-setup.exe with a valid
...
that the newbit-qt.exe file inside the installer had not been tampered with.
