...
#ifndef NEWBIT_CONSENSUS_CONSENSUS_H
#define NEWBIT_CONSENSUS_CONSENSUS_H
...
// version. The former uses NewBit parameters, but if this fork is a fork
...
#define select_activation_height(height) (height > FORK_BLOCK ? FORK_BLOCK + (!FORK_BLOCK) : height)
...
#endif // NEWBIT_CONSENSUS_CONSENSUS_H
