...
void PushNodeVersion(CNode* pnode, CConnman& connman, int64_t nTime)
{
    ...
    connman.PushMessage(pnode, CNetMsgMaker(INIT_PROTO_VERSION).Make(NetMsgType::VERSION, PROTOCOL_VERSION, (uint64_t)nLocalNodeServices, nTime, addrYou, addrMe, nonce, strSubVersion, nNodeStartingHeight, ::fRelayTxes, FORK_HASH_UINT256));
                ...
                for (auto mi = itByPrev->second.begin();
                    ...
                    if (AcceptToMemoryPool(mempool, stateDummy, porphanTx, true, &fMissingInputs2, &lRemovedTxn)) {
                        ...
                        if (!orphanTx.HasWitness() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/newbit/newbit/issues/8279 for details.
                            assert(recentRejects);
