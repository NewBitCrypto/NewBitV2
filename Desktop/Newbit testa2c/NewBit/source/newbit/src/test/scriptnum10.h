...
#ifndef NEWBIT_TEST_SCRIPTNUM10_H
#define NEWBIT_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from NewBit Core 0.10.0, for cross-comparison.
 */
public:
    ...
    explicit CScriptNum10(const std::vector<unsigned char>& vch, bool fRequireMinimal, const size_t nMaxNumSize = nDefaultMaxNumSize)
    {
