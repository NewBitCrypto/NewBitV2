...
#ifndef NEWBIT_QT_NEWBITUNITS_H
#define NEWBIT_QT_NEWBITUNITS_H
...
/** NewBit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NewBitUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NewBitUnits(QObject* parent);

    /** NewBit units.
      @note Source: https://en.newbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        NBC,
        mNBC,
...
typedef NewBitUnits::Unit NewBitUnit;

#endif // NEWBIT_QT_NEWBITUNITS_H
