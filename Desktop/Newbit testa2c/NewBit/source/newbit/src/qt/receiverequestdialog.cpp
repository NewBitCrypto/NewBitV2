...
#include "config/newbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNewBitURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + NewBitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNewBitURI(info));
}
