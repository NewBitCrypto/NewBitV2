...
class BIP66Test(NewBitTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # newbitd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and newbitd produces more specific reject
            # reasons.
