...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NewBitTestFramework
    pass

class ExampleTest(NewBitTestFramework):
    # Each functional test is a subclass of the NewBitTestFramework class.
    ...
    def custom_method(self):
        ...
        NewBitTestFramework class so other tests can use it."""
