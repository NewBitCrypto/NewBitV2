...
# TestNode: A peer we use to send messages to newbitd, and store responses.
...
class CompactBlocksTest(NewBitTestFramework):
    ...
    # This test actually causes newbitd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that newbitd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for newbitd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # newbitd will not send blocktxn responses for blocks whose height is
