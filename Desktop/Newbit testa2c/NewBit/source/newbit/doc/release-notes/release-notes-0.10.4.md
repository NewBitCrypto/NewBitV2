NewBit Core version 0.10.4 is now available from:

  <https://newbit.org/bin/newbit-core-0.10.4/>
...
- #6953 `43c2789` Split newbit-tx into its own package
- #6953 `dfe0d4d` Include newbit-tx binary on Debian/Ubuntu
