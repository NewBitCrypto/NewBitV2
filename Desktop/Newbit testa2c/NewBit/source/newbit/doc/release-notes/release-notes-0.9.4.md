NewBit Core version 0.9.4 is now available from:

  https://newbit.org/bin/0.9.4/
...
this update is incompatible with the NewBit system and could lead to consensus
forks.

NewBit Core released binaries from https://newbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~newbit/+archive/ubuntu/newbit
- A third-party or self-compiled NewBit Core

upgrade to NewBit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
