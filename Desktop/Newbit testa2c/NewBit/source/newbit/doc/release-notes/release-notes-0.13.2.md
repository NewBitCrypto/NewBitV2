NewBit Core version 0.13.2 is now available from:

  <https://newbit.org/bin/newbit-core-0.13.2/>
...
- #8908 `4a974b2` Update newbit-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow newbit-tx to create v2 transactions (btcdrak)
