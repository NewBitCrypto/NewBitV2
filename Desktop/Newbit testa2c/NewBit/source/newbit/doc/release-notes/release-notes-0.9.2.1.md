NewBit Core version 0.9.2.1 is now available from:

  https://newbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NBC to 0.01 NBC
...
- Fix "Start newbit on system login"
