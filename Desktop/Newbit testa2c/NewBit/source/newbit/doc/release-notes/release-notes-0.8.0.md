NewBit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/newbit/files/NewBit/newbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the NewBit
...
New/changed settings (command-line or newbit.conf file)
--------------------------------------------------------
