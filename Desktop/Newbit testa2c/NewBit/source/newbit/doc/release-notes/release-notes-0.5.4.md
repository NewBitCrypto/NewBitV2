NewBit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/newbit/files/NewBit/newbit-0.5.4/
...
http://gitorious.org/newbit/newbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix NewBit-Qt notifications under Growl 1.3.
Increase required age of NewBit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNewBit properly when installing NewBit-Qt over it. (Windows)
