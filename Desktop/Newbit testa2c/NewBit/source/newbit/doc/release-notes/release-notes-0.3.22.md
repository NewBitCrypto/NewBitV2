Download URL: https://sourceforge.net/projects/newbit/files/NewBit/newbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NBC fee schedule (users still pay 0.01 NBC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #newbit00 - #newbit99
