...
This document provides guidelines for internationalization of the NewBit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `newbit_en.ts` remains unchanged.
